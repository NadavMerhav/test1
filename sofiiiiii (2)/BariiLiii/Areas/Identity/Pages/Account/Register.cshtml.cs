...
namespace BariiLiii.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new BariiLiiiUser { FullName = Input.FullName, UserName = Input.Email, Gender=Input.Gender,Location=Input.Location, Email = Input.Email };
                //var patient = new Patient { PatientId = user.Id, FullName = user.FullName, Gender = Input.Gender, Location = Input.Location };
